...
joint_state.position[2] = H_state.joint[RHP].pos;//RHP
   // printf("Joint = %f\r\n",msg.enco_d[2]);
joint_state.name[3]="joint_49" ;
joint_state.position[3] = H_state.joint[RKN].pos;//RKP
  //  printf("Joint = %f\r\n",msg.enco_d[3]);
...
joint_state.position[8] = H_state.joint[LHP].pos;//LHP
  //  printf("Joint = %f\r\n",msg.enco_d[8]);
joint_state.name[9]="joint_43" ;
joint_state.position[9] = H_state.joint[LKN].pos;//LKP(urd naming)
   // printf("Joint = %f\r\n",msg.enco_d[9]);
